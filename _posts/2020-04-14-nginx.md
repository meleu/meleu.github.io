...
- [Instalando](#instalando)
    ...
    - [Iniciar NginX durante o boot com systemd](#iniciar-nginx-durante-o-boot-com-systemd)
    - [Usando NginX via docker](#usando-nginx-via-docker)
- [Conceitos básicos](#conceitos-básicos)
    - [Directive](#directive)
        - [Tipos de Diretivas](#tipos-de-diretivas)
            - [Diretivas Normais](#diretivas-normais)
            - [Diretivas Array](#diretivas-array)
            - [Diretivas de Ação](#diretivas-de-ação)
    - [Context](#context)
