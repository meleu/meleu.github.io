...
Para realizar testes vamos usar o `siege` (instalável via `apt-get`):
```
$ # 2 repetições de 10 requisições simultâneas:
$ siege -v -r 2 -c 10 http://localhost/thumb.png
** SIEGE 3.0.8
** Preparing 10 concurrent users for battle.
The server is now under siege...
HTTP/1.1 503   0.00 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.01 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.00 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.00 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 200   0.38 secs: 1030842709 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.00 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.02 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.03 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.03 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.03 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.03 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.03 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.02 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.10 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.10 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.10 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.00 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 200   0.45 secs: 1030842709 bytes ==> GET  /video.mp4
HTTP/1.1 503   0.07 secs:     197 bytes ==> GET  /video.mp4
HTTP/1.1 200   0.49 secs: 1030842709 bytes ==> GET  /video.mp4
```

Outras configs úteis a serem usadas na hora de "chamar" a zona de limitação, são `burst=` e `nodelay`.

TODO: explicar as opções `burst=` e `nodelay`.
